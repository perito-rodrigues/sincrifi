...
def convertToSqlServer():
    ...
    file = open(_INPUT_PATH_+"/"+_CASO_PREFIX_+"/"+_CASO_PREFIX_+"_ORIGEM_DESTINO.TXT", "r")
    ...
    file = open(_INPUT_PATH_+"/"+_CASO_PREFIX_+"/"+_CASO_PREFIX_+"_EXTRATO.TXT")
    ...
    file = open(_INPUT_PATH_+"/"+_CASO_PREFIX_+"/"+_CASO_PREFIX_+"_TITULARES.TXT")
    ...
    file = open(_INPUT_PATH_+"/"+_CASO_PREFIX_+"/"+_CASO_PREFIX_+"_AGENCIAS.TXT")
    ...
    file = open(_INPUT_PATH_+"/"+_CASO_PREFIX_+"/"+_CASO_PREFIX_+"_CONTAS.TXT", "r")
